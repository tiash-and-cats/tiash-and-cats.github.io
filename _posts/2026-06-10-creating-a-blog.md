...
Firstly, I had to create an LinkedIn app. To do that, I went to [LinkedIn Developer Solutions](https://developer.linkedin.com) and clicked on `Create app`. But to create the app, I had to input a Company Page to associate it with. Thankfully, there are some "Default Company Pages for Individual Developers" that I could use. 
